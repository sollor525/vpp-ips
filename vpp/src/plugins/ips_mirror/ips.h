 ...
 * Each node has its own counter set to avoid double-counting */
typedef enum
{
    /* ========== Input Node Counters ========== */
    IPS_COUNTER_INPUT_PACKETS = 0,
    IPS_COUNTER_INPUT_BYTES,
    IPS_COUNTER_INPUT_IPV4_PACKETS,
    IPS_COUNTER_INPUT_IPV6_PACKETS,
    IPS_COUNTER_INPUT_TCP_PACKETS,
    IPS_COUNTER_INPUT_UDP_PACKETS,
    IPS_COUNTER_INPUT_OTHER_PROTOCOLS,
    IPS_COUNTER_INPUT_NON_TCP_DROPPED,

    /* ========== TCP Session Node Counters ========== */
    IPS_COUNTER_SESSION_PACKETS_SEEN,
    IPS_COUNTER_SESSION_PACKETS_PROCESSED,
    IPS_COUNTER_SESSION_BYTES_SEEN,
    IPS_COUNTER_SESSION_BYTES_PROCESSED,
    ...
    IPS_COUNTER_PROTO_DETECT_PACKETS_IN,
    IPS_COUNTER_PROTO_DETECT_PROCESSED,
    IPS_COUNTER_PROTO_DETECT_ATTEMPTS,
    IPS_COUNTER_PROTO_DETECT_SUCCESS,
    IPS_COUNTER_PROTO_DETECT_INSUFFICIENT_DATA,
    IPS_COUNTER_PROTO_DETECT_NO_PAYLOAD,
    ...
    IPS_COUNTER_INSPECT_PACKETS_IN,
    IPS_COUNTER_INSPECT_PROCESSED,
    IPS_COUNTER_INSPECT_PERFORMED,
    IPS_COUNTER_INSPECT_BYTES_SCANNED,
    IPS_COUNTER_INSPECT_PATTERN_MATCHES,
    IPS_COUNTER_INSPECT_HYPERSCAN_CALLS,
    IPS_COUNTER_INSPECT_PCRE_CALLS,
    IPS_COUNTER_INSPECT_RULE_MATCHES,
    IPS_COUNTER_INSPECT_RULES_TRIGGERED,
    IPS_COUNTER_INSPECT_ALERTS_GENERATED,
    IPS_COUNTER_INSPECT_PACKETS_PASSED,
    IPS_COUNTER_INSPECT_PACKETS_DROPPED,
    IPS_COUNTER_INSPECT_ERRORS,
    IPS_COUNTER_INSPECT_SESSION_NOT_FOUND,

    /* ========== Block Node Counters ========== */
    IPS_COUNTER_BLOCK_PACKETS_IN,
    IPS_COUNTER_BLOCK_SENT,
    IPS_COUNTER_BLOCK_TCP_RESETS_SENT,
    IPS_COUNTER_BLOCK_ERRORS,
    IPS_COUNTER_BLOCK_ALREADY_BLOCKED,
    IPS_COUNTER_BLOCK_NON_TCP_DROPPED,
    ...
    IPS_COUNTER_ACL_VPP_HITS,
    IPS_COUNTER_ACL_VPP_PERMIT_HITS,
    IPS_COUNTER_ACL_VPP_DENY_HITS,
