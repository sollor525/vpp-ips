...
/* Timer IDs - we use bit 31 for timer ID encoding */
#define IPS_SESSION_EXPIRE_TIMER_ID 0
#define IPS_SESSION_TIMER_ID_MASK   0x80000000

/* Timer handle encoding: [31:timer_id][30:0:session_index] */
#define IPS_TIMER_HANDLE_MAKE(session_index, timer_id) \
    ((session_index) | ((timer_id) << 31))

#define IPS_TIMER_HANDLE_SESSION_INDEX(handle)  ((handle) & 0x7FFFFFFF)
#define IPS_TIMER_HANDLE_TIMER_ID(handle)       (((handle) >> 31) & 0x1)
 ...
 */
u32 ips_session_timer_start(u32 thread_index, u32 session_index, u32 timeout_seconds);
 ...
 */
void ips_session_timer_stop(u32 thread_index, u32 timer_handle);
 ...
 */
void ips_session_timer_update(u32 thread_index, u32 timer_handle, u32 timeout_seconds);
